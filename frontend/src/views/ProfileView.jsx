...
export default function ProfileView() {
    ...
    useEffect(() => {
        axiosClient.get(`/${role}/profile/${id}`).then(res => {
        ...
        <PageComponent title={"Profile"}>
            <p className="text-sm font-medium text-gray-500 pb-4">
                <span className="inline-flex items-center">
                    ...
                    You can view and update your profile here
                </span>
            </p>
            <form action="#" method="POST" onSubmit={onSubmit} className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                        ...
                        <div className="col-span-6 sm:col-span-3">
                            ...
                            <div className="flex flex-col items-center">
                                {!imageUrl && (
                                    <span className="flex justify-center items-center text-gray-400 mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-100">
