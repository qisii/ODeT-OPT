...
import { CheckCircleIcon, MinusCircleIcon, PencilIcon } from "@heroicons/react/24/outline";

export default function LogRequestListItem({ log, onEditClick }) {
...
return (
    <tr key={log.id} onClick={handleEditClick} className="py-5 border-b border-gray-200 hover:bg-gray-50">
        ...
        <td className="px-4 py-2 border-r border-gray-200">
        <p className="text-sm leading-6 text-gray-500">{log.pd_num}</p>
        </td>
        <td className="px-4 py-2 border-r border-gray-200">
        <p className="text-sm leading-6 text-gray-500">{log.suc_num}</p>
        </td>
        <td className="px-4 py-2 border-r border-gray-200">
