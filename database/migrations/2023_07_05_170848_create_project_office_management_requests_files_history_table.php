...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('project_office_management_requests_files_history', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('project_office_management_requests_files_history');
    }
};
