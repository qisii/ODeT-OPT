...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('internal_office_process_requests_files_history', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('internal_office_process_requests_files_history');
    }
};
