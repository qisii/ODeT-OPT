...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_international_requests', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        DB::unprepared('
            CREATE TRIGGER student_international_requests_trigger
            AFTER INSERT OR UPDATE OR DELETE ON student_international_requests
            FOR EACH ROW
            EXECUTE FUNCTION student_international_requests_trigger_function()
        ');
    }
    ...
    {
        // Drop the trigger
        DB::unprepared('DROP TRIGGER IF EXISTS student_international_requests_trigger ON student_international_requests');
        
        Schema::dropIfExists('student_international_requests');
    }
};
